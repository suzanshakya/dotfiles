...
ll /Users/suzanshakya/.virtualenvs/pythoncrawlers/bin/python*
mv /Users/suzanshakya/.virtualenvs/pythoncrawlers/bin/python{,.bak}
which python
ll /usr/local/Cellar/python2.6/2.6.5/bin/python
ln -s /usr/local/Cellar/python2.6/2.6.5/bin/python /Users/suzanshakya/.virtualenvs/pythoncrawlers/bin/python
which python
python
cd $product_spiders 
workon pythoncrawlers
...
deactivate 
pwd
mv ~/.virtualenvs/pythoncrawlers{,.bak}
mkvirtualenv pythoncrawlers
which python
python
pwd
...
pwd
pserve
du -sh ~/.virtualenvs/pythoncrawlers.bak/
vi productspidersweb/setup.
vi productspidersweb/setup.py 
du -sh ~/.virtualenvs/pythoncrawlers
du -sh ~/.virtualenvs/pythoncrawlers*
python setup.py develop
u
pwd
pserve productspidersweb/development.ini 
which python
mv .virtualenvs/pythoncrawlers{,2.6}
mv .virtualenvs/pythoncrawlers{.bak,}
cd $product_spiders 
deactivate 
workon pythoncrawlers
...
which python
workon pythoncrawlers
scrapy runspider product_spiders/spiders/suzan/
scrapy runspider product_spiders/spiders/suzan/surreypetsupplies_spider.py
scrapy server
pserve development.ini 
git status
git add product_spiders/spiders/suzan/surreypetsupplies_spider.py
git add product_spiders/spiders/suzan/__init__.py
git status .
git commit -m'added spiders'
scrapy runspider product_spiders/spiders/suzan/surreypetsupplies_spider.py
gd
gd .
scrapy runspider product_spiders/spiders/suzan/surreypetsupplies_spider.py
